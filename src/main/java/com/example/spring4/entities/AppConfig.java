...
public class AppConfig {
    ...
    public Tavolo tavolo1(){
        return new Tavolo(1,5,Stato.OCCUPATO);
    }
    ...
    @Bean
    public List<Item> ordinati() {
        List<Item> itemList = new ArrayList<>();
        itemList.add(pizzaHawaiianBean());
        itemList.add(pizzaSalamiBean());
    ...
    public Ordine ordine1() {
        return new Ordine(1, tavolo1().getId(), StatoOrdine.INCORSO, ordinati(), 3, "12:30");
    }
